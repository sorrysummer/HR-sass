  ...
  <div class="user-info">
    ...
    <el-form label-width="220px">
      ...
      <el-row class="inline-info" type="flex" justify="center">
        <el-col :span="12">
          <el-button type="primary" @click="saveStaffInfo">保存更新</el-button>
    ...
    <el-form label-width="220px">
      ...
      <div class="block">
        ...
        <el-row class="inline-info" type="flex" justify="center">
          <el-col :span="12">
            <el-button type="primary" @click="savePersonlInfo"
              >保存更新</el-button
            >
            <el-button @click="$router.back()">返回</el-button>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    async getPersonlInfo() {
      this.formData = await getPersonlInfoApi(this.userId);
    ...
    async savePersonlInfo() {
      const fileList = this.$refs.imgs.fileList;
      if (fileList.some((item) => !item.upload)) {
        this.$message.warning("图片未上传成功");
        return;
      }
      await savePersonlInfoApi({
        ...this.formData,
        staffPhoto: fileList.length ? fileList[0].url : " ",
      });
